"""
===============================================================================
Prototype V2.1 - Guided Controlled Dataset Acquisition System
===============================================================================

File:
    record_dataset_v2_1.py

HOW TO RUN THE FILE:
    python record_dataset_v2_1.py
...
===============================================================================
NEW 15-TRIAL PROTOCOL FOR POWER-ADAPTER IMPROVEMENT
===============================================================================

This experiment is focused on collecting stronger training data for the
power adapter, especially during motion, rotation, hand interaction,
and occlusion.

Trial 01: Adapter slow left movement
Trial 02: Adapter slow right movement
Trial 03: Adapter forward/back movement
Trial 04: Adapter diagonal movement
Trial 05: Adapter fast movement
Trial 06: Adapter pick and place
Trial 07: Adapter 45 degree rotation
Trial 08: Adapter 90 degree rotation
Trial 09: Adapter random rotation
Trial 10: Adapter partial hand occlusion
Trial 11: Adapter heavy hand occlusion
Trial 12: Adapter near image border
Trial 13: Adapter partially outside image
Trial 14: Adapter mixed realistic movement
Trial 15: Adapter movement with hand interaction
...
WINDOW_NAME = "Prototype V2.1 - Dataset Acquisition"

DEFAULT_EXPERIMENT_ID = "experiment_002_power_adapter_improvement"

DEFAULT_STARTING_TRIAL_NUMBER = 1

DEFAULT_OBJECTS_PRESENT = "power_adapter"
...
TRIAL_PROTOCOL = {
    1: {
        "trial_condition": "adapter_slow_left",
        "label": "Adapter slow left movement",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter slowly to the left and keep it visible.",
    },
    2: {
        "trial_condition": "adapter_slow_right",
        "label": "Adapter slow right movement",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter slowly to the right and keep it visible.",
    },
    3: {
        "trial_condition": "adapter_forward_backward",
        "label": "Adapter forward and backward movement",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter forward and backward within the workspace.",
    },
    4: {
        "trial_condition": "adapter_diagonal_movement",
        "label": "Adapter diagonal movement",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter diagonally across the workspace.",
    },
    5: {
        "trial_condition": "adapter_fast_movement",
        "label": "Adapter fast movement",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter quickly to create motion variation.",
    },
    6: {
        "trial_condition": "adapter_pick_and_place",
        "label": "Adapter pick and place",
        "objects_present": "power_adapter",
        "instruction": "Pick up the power adapter and place it back on the table.",
    },
    7: {
        "trial_condition": "adapter_rotation_45",
        "label": "Adapter 45 degree rotation",
        "objects_present": "power_adapter",
        "instruction": "Rotate the power adapter approximately 45 degrees.",
    },
    8: {
        "trial_condition": "adapter_rotation_90",
        "label": "Adapter 90 degree rotation",
        "objects_present": "power_adapter",
        "instruction": "Rotate the power adapter approximately 90 degrees.",
    },
    9: {
        "trial_condition": "adapter_random_rotation",
        "label": "Adapter random rotation",
        "objects_present": "power_adapter",
        "instruction": "Rotate the power adapter to a random angle and keep it visible.",
    },
    10: {
        "trial_condition": "adapter_partial_hand_occlusion",
        "label": "Adapter partial hand occlusion",
        "objects_present": "power_adapter",
        "instruction": "Partially cover the power adapter with your hand.",
    },
    11: {
        "trial_condition": "adapter_heavy_hand_occlusion",
        "label": "Adapter heavy hand occlusion",
        "objects_present": "power_adapter",
        "instruction": "Cover most of the power adapter with your hand and reveal it again.",
    },
    12: {
        "trial_condition": "adapter_near_border",
        "label": "Adapter near image border",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter close to the image border.",
    },
    13: {
        "trial_condition": "adapter_partially_outside",
        "label": "Adapter partially outside image",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter partly outside the camera view and bring it back.",
    },
    14: {
        "trial_condition": "adapter_mixed_realistic_movement",
        "label": "Adapter mixed realistic movement",
        "objects_present": "power_adapter",
        "instruction": "Move, rotate, and reposition the power adapter in a realistic way.",
    },
    15: {
        "trial_condition": "adapter_movement_hand_interaction",
        "label": "Adapter movement with hand interaction",
        "objects_present": "power_adapter",
        "instruction": "Move the power adapter while your hand interacts with it repeatedly.",
    },
}
...
def initialize_metadata_file():
    ...
    if existing_header != CSV_COLUMNS:
        ...
        print()
        print("Then run record_dataset_v2_1.py again.")
        print("=" * 70)
        return False
...
TRIAL_CONDITION_OPTIONS = {
    1: ("adapter_slow_left", "Adapter slow left movement", "power_adapter"),
    2: ("adapter_slow_right", "Adapter slow right movement", "power_adapter"),
    3: ("adapter_forward_backward", "Adapter forward/back movement", "power_adapter"),
    4: ("adapter_diagonal_movement", "Adapter diagonal movement", "power_adapter"),
    5: ("adapter_fast_movement", "Adapter fast movement", "power_adapter"),
    6: ("adapter_pick_and_place", "Adapter pick and place", "power_adapter"),
    7: ("adapter_rotation_45", "Adapter 45 degree rotation", "power_adapter"),
    8: ("adapter_rotation_90", "Adapter 90 degree rotation", "power_adapter"),
    9: ("adapter_random_rotation", "Adapter random rotation", "power_adapter"),
    10: ("adapter_partial_hand_occlusion", "Adapter partial hand occlusion", "power_adapter"),
    11: ("adapter_heavy_hand_occlusion", "Adapter heavy hand occlusion", "power_adapter"),
    12: ("adapter_near_border", "Adapter near image border", "power_adapter"),
    13: ("adapter_partially_outside", "Adapter partially outside image", "power_adapter"),
    14: ("adapter_mixed_realistic_movement", "Adapter mixed realistic movement", "power_adapter"),
    15: ("adapter_movement_hand_interaction", "Adapter movement with hand interaction", "power_adapter"),
}
...
def ask_trial_condition(previous_condition=None):
    ...
    while True:
        ...
        try:
            ...
            print("ERROR: Enter a menu number, 'c' for custom, or 'X' to cancel.")
            continue
...
def main():
    ...
    print("=" * 70)
    print("PROTOTYPE V2.1 - GUIDED CONTROLLED DATASET ACQUISITION")
    print("=" * 70)
    ...
    print("S = Stop and save metadata")
    print("Q = Quit")
    print("-" * 70)
